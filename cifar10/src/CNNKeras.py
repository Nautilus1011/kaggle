...
# save_path = os.path.join(output_path, "Distribution_of_the_data")
...
# tf.data を使ってデータローダーを作成
# train_dataset = (
#     tf.data.Dataset.from_tensor_slices((x_train, y_train))
#     .shuffle(buffer_size=50000)
#     .batch(batch_size)
#     .prefetch(tf.data.AUTOTUNE)  # GPUの計算とデータロードを並列処理
# )
...
# Y_true = np.random.randint(0, 10, 1000)  # 例として1000個のランダムなラベル
# Y_pred = np.random.randint(0, 10, 1000)  # 例として1000個のランダムな予測
